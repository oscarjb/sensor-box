...
COCO_WEIGHTS_PATH ="/home/evida/3D_UPP/Mask_RCNN-master/mask_rcnn_coco.h5"

# Directory to save logs and model checkpoints, if not provided
# through the command line argument --logs
DEFAULT_LOGS_DIR = "/home/evida/3D_UPP/Mask_RCNN-master/logs_coco_resnet50_2020"
...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        self.add_class("type", 1, "Contour")
        self.add_class("type", 2, "Ruler")
        ...
        #for i in range(40,41):
            ...
            a=annotations[i]
            for r in a['regions']:
                polygons1.append(r['shape_attributes'])
                objects.append(r['region_attributes'])
            
            for n in objects:
                class_ids1.append(n['type'])
            #print(class_ids1)
            for j in class_ids1:
                if j=="Contour":
                    class_ids.append(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', required=True,
                        metavar="/home/evida/3D_UPP/Mask_RCNN-master/mask_rcnn_coco.h5",
                        help="Path to weights .h5 file or 'coco'")
    parser.add_argument('--logs', required=False,
                        default=DEFAULT_LOGS_DIR,
                        metavar="/home/evida/3D_UPP/Mask_RCNN-master/logs_coco_resnet50_2020",
